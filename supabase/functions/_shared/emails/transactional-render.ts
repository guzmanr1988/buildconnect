// BuildConnect transactional email renderer (Edge Functions mirror).
// Source of truth: src/lib/emails/render-email.ts — iris owns the contract.
// Mirrored here because Supabase Edge Functions can't reach into FE src/.
// Keep both copies byte-equal; any iris change must be applied to both.
