...
export const MOCK_LEADS: Lead[] = [
  { id: 'L-0001', homeowner_id: 'ho-1', vendor_id: 'v-1', project: 'Full Roof Replacement — Barrel Tile', value: 28500, status: 'confirmed', slot: '2026-04-14T09:00:00Z', permit_choice: true, service_category: 'roofing', pack_items: { material: ['barrel_tile'], service_type: ['replace'], addons: ['gutters'] }, sq_ft: 2100, financing: false, address: '1234 Coral Way, Miami, FL 33145', phone: '(305) 555-0101', email: 'maria@email.com', homeowner_name: 'Maria Rodriguez', received_at: '2026-04-07T14:22:00Z' },
