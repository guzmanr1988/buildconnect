...
// reads from doc.uploadedBy (RLS-gated source-of-truth column). The
// "system" case (apollo flag, kratos msg 1781648756389) labels auto-
// generated docs (e.g. Mark-as-Sold project_report) so the homeowner
// doesn't see them as a mystery upload.
export function uploaderChip(doc: HomeownerDoc): string | null {
  ...
  if (doc.uploadedBy === 'system') return 'Generated by BuildConnect'
  return null
}
