...
const CITY_OPTIONS: CityOption[] = [
  ...
  { key: 'opa-locka',       label: 'Opa-locka',               pdfPath: '/permits/city-permit/opa-locka.pdf',       portalUrl: 'https://www.opalockafl.gov/73/Building-Licenses' },
  { key: 'miami-gardens',   label: 'Miami Gardens',           pdfPath: '/permits/city-permit/miami-gardens.pdf',   portalUrl: 'https://www.miamigardens-fl.gov/194/Permits-Enforcement' },
...
const NOC_JURISDICTIONS: NocJurisdiction[] = [
  ...
  { key: 'opa-locka',       label: 'Opa-locka',               pdfPath: '/permits/notice-of-commencement/miami-dade.pdf',   downloadName: 'noc-opa-locka-signed.pdf' },
  { key: 'miami-gardens',   label: 'Miami Gardens',           pdfPath: '/permits/notice-of-commencement/miami-dade.pdf',   downloadName: 'noc-miami-gardens-signed.pdf' },
