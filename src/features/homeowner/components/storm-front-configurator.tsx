...
export function StormFrontConfigurator({ selections, onChange, onSave }: StormFrontConfiguratorProps) {
  ...
  // accordion, same shape as sibling WindowConfigurator/DoorConfigurator.
                ...
                <div key={size} className="flex flex-col">
                  {isMobile ? (
                    <button
                      ...
                      aria-controls={`storm-front-panel-${size}`}
                      data-storm-front-size-row={size}
                      data-storm-front-size-header={size}
                      data-storm-front-size-open={isOpen ? 'true' : 'false'}
                      className={cn(
                              ...
                              {isMobile ? (
                                <>
                                  <div className="flex flex-col gap-1">
                                    ...
                                    >
                                      <SelectTrigger className="h-10 text-sm" data-storm-front-type-select={entry.id}>
                                        <SelectValue />
                                      </SelectTrigger>
                                      <SelectContent>
                                  ...
                                  <div className="flex items-center justify-between gap-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                      <Button variant="outline" size="icon" className="h-9 w-9" onClick={() => adjustQuantity(entry.id, -1)} data-storm-front-qty-minus={entry.id}>
                                        <Minus className="h-4 w-4" />
                                      </Button>
                                      <span className="text-base font-semibold w-8 text-center text-primary" data-storm-front-qty-value={entry.id}>{entry.quantity}</span>
                                      <Button variant="outline" size="icon" className="h-9 w-9" onClick={() => adjustQuantity(entry.id, 1)} data-storm-front-qty-plus={entry.id}>
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    >
                                      <SelectTrigger className="h-10 text-sm" data-storm-front-frame-color-select={entry.id}>
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    >
                                      <SelectTrigger className="h-10 text-sm" data-storm-front-glass-color-select={entry.id}>
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    >
                                      <SelectTrigger className="h-10 text-sm" data-storm-front-glass-type-select={entry.id}>
                                  ...
                                  <Button
                                    ...
                                    data-storm-front-remove={entry.id}
                                  >
                                    <Trash2 className="h-3.5 w-3.5" />
                                    Remove this storm front
                                  </Button>
                                </>
                              ) : (
                                <>
                          ...
                          {isMobile && (
                            <div className="flex flex-col gap-2 pt-3">
                              <Button
                                ...
                                onClick={() => addEntry(size)}
                                data-storm-front-add-another={size}
                              >
                                <PlusCircle className="h-4 w-4" />
                                Add another storm front this size
                              </Button>
                              <Button
                                className="h-11 w-full rounded-xl text-sm font-semibold"
                                onClick={() => setOpenSize(null)}
                                data-storm-front-save-size={size}
                              >
                                Save
                              </Button>
                            </div>
