            ...
            return (
              <div className="space-y-5">
                ...
                <div className="space-y-6">
                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-2 min-w-0">
                            {optionIds.map((optId) => {
                              ...
                              return (
                                <Badge key={optId} variant="secondary" className="text-sm px-3 py-1 max-w-full whitespace-normal h-auto text-center">
                                  {label}{qty}
                                </Badge>
                              )
                            })}
                  ...
                  {/* Window selections — 2-col grid (multiple items per
                      row) with per-card specs at the card bottom. Each
                      card is 2 logical rows: size + ×qty up top, the
                      4-chip spec strip (type / frame / glass / glassType)
                      below. Per Rod photo file_330 — hoisting the shared
                      spec stripped per-card detail he wanted preserved;
                      the rework restores per-card specs while keeping the
                      2-col layout. */}
                  ...
                  {/* Door selections — same 2-col + per-card-specs treatment. */}
